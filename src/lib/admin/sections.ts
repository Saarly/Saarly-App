...
export const sections: SectionConfig[] = [
  ...
  },
  {
    ...
    description: {
      ar: "عرض المستخدمين الذين لديهم إحالة مؤكدة واحدة على الأقل، ومتابعة استحقاق المكافآت وتسليمها.",
      en: "Show users with at least one confirmed referral and track reward eligibility and delivery.",
    },
    searchKeys: [
      "referrer_name",
      "referrer_email",
    ...
    allowedRoles: ["admin"],
    columns: [
      { key: "referrer_name", label: { ar: "المستخدم", en: "User" } },
      { key: "referrer_email", label: { ar: "البريد الإلكتروني", en: "Email" } },
      { key: "referrer_mobile", label: { ar: "رقم الهاتف", en: "Phone" } },
      { key: "referral_code", label: { ar: "كود الإحالة", en: "Referral code" }, tone: "status" },
      { key: "confirmed_registrations", label: { ar: "الإحالات المؤكدة", en: "Confirmed referrals" } },
      { key: "target_confirmed_registrations", label: { ar: "الهدف الحالي", en: "Current target" } },
      { key: "remaining_registrations", label: { ar: "المتبقي", en: "Remaining" } },
      { key: "reward_type", label: { ar: "نوع المكافأة", en: "Reward type" }, tone: "status" },
      { key: "milestone_number", label: { ar: "رقم الاستحقاق", en: "Milestone" } },
      { key: "qualified_registrations", label: { ar: "إجمالي الإحالات عند الاستحقاق", en: "Qualified at" } },
      { key: "status_ar", label: { ar: "حالة الاستحقاق", en: "Eligibility status" }, tone: "status" },
      { key: "reward_delivery_status_ar", label: { ar: "حالة تسليم المكافأة", en: "Reward delivery status" }, tone: "status" },
      { key: "delivered_at", label: { ar: "تاريخ تسليم المكافأة", en: "Reward delivery date" }, tone: "date" },
    ],
  },
  {
    id: "audit",
