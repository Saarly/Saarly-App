...
function senderLabel(message: Message, lang: Lang) {
  ...
  if (message.sender_type === "user") return lang === "ar" ? "عميل" : "Customer";
  if (message.sender_type === "bot") return lang === "ar" ? "بوت" : "Bot";
  if (message.sender_type === "support_agent") return lang === "ar" ? "الدعم" : "Support";
...
function supportStatusLabel(status: string, lang: Lang) {
  if (status === "transferred") return lang === "ar" ? "محول للدعم" : "Transferred to support";
...
function assignedLabel(conversation: Conversation, lang: Lang) {
  return conversation.assigned_agent_name || (lang === "ar" ? "غير معين" : "Unassigned");
}
        ...
        <aside className="queue-card">
          ...
          <div className="queue-list">
            {conversations.map((conversation) => (
              ...
              >
                <strong>{conversation.title || (lang === "ar" ? "محادثة الدعم" : "Support chat")}</strong>
                <span>{supportStatusLabel(conversation.status, lang)}</span>
                <span>
                  {lang === "ar" ? "بواسطة: " : "Handled by: "}
          ...
          {selected ? (
            <>
              <div className="chat-head">
                <div>
                  <strong>{selected.title || (lang === "ar" ? "محادثة الدعم" : "Support chat")}</strong>
            ...
            <div className="empty-chat">
              ...
              <span>{lang === "ar" ? "الردود تصل مباشرة." : "Replies arrive through Realtime."}</span>
            </div>
          )}
        </article>
      </div>
